...
#filename="/Users/jima/LEPP/DarkSector/CODE/radBhabha/madevent/Events/run_02/unweighted_events.lhe"
outfilename="data_radBhabha2.lhe"
...
for line in getline:
	...
	if status=="InEvent":
		...
		if (angleLab > 2.0*pi/180. and angleLab < 5.0*pi/180.):  ngoodparticle=ngoodparticle+1			
		event_lines.append(line)
...
print "nAccepted=",ngoodparticle, " nphotons=",ntry, " nEvents=",ievt," Acceptance=",float(naccepted)/float(ievt)	
